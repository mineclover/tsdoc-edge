...
> **Type**: `test-coverage` | **Status**: ✅ Implemented

Map test files to implementation (`*.test.ts` → source).

**Implementation**: [[TestRelationshipAnalyzer]] (`src/analyzer/TestRelationshipAnalyzer.ts`)  
**Command**: [[AnalyzeTestsCommand]]
...
- [[CoverageParser]] → /Users/junwoobang/workflow/tsdoc-edge/managed/analyzers/CoverageParser.md:22
- [[CoverageSyncAdapter]] → /Users/junwoobang/workflow/tsdoc-edge/managed/analyzers/CoverageSyncAdapter.md:21
- [[IntegrationCoverageCalculator]] → /Users/junwoobang/workflow/tsdoc-edge/managed/analyzers/IntegrationCoverageCalculator.md:22
- [[TestCoverageAnalyzer]] → /Users/junwoobang/workflow/tsdoc-edge/managed/analyzers/TestCoverageAnalyzer.md:22
- [[TestRelationshipAnalyzer]] → /Users/junwoobang/workflow/tsdoc-edge/managed/analyzers/TestRelationshipAnalyzer.md:22
- [[TestRelationshipExtractor]] → /Users/junwoobang/workflow/tsdoc-edge/managed/analyzers/TestRelationshipExtractor.md:23
- [[AnalyzeTestsCommand]] → /Users/junwoobang/workflow/tsdoc-edge/managed/commands/AnalyzeTestsCommand.md:22
- [[Phase5Commands]] → /Users/junwoobang/workflow/tsdoc-edge/managed/commands/Phase5Commands.md:21
