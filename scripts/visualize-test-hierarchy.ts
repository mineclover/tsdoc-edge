...
console.log(`   ${'File'.padEnd(40)} ${'Suites'.padStart(7)} ${'Cases'.padStart(7)} ${'Scenarios'.padStart(10)} ${'Total'.padStart(7)}`);
console.log(`   ${'─'.repeat(40)} ${'─'.repeat(7)} ${'─'.repeat(7)} ${'─'.repeat(10)} ${'─'.repeat(7)}`);
