...
import { FileReferenceUpdater, type UpdateOptions } from '../../utilities/FileReferenceUpdater';
...
describe('FileReferenceUpdater', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = fs.mkdtempSync(path.join(require('node:os').tmpdir(), 'file-ref-test-'));
  });
  ...
  describe('findReferences', () => {
    describe('backlink references', () => {
      it('should find backlink references with arrow notation', async () => {
        ...
        const refs = await updater.findReferences('features/old-feature.md', tempDir);
    ...
    describe('with newPath provided', () => {
      it('should calculate newText for references', async () => {
        ...
        const refs = await updater.findReferences('old-feature.md', tempDir, 'new-feature.md');
    ...
    describe('edge cases', () => {
      it('should return empty array for non-existent directory', async () => {
        const refs = await updater.findReferences('old.md', '/non/existent/path');
        expect(refs).toEqual([]);
      });
      ...
      it('should skip node_modules directory', async () => {
        ...
        fs.writeFileSync(path.join(nodeModules, 'doc.md'), '→ old-feature.md');
  ...
  describe('updateReferences', () => {
    describe('dry run mode', () => {
      it('should not modify files in dry run mode', async () => {
        ...
        const result = await updater.updateReferences('old-feature.md', 'new-feature.md', options);
